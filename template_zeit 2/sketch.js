...
let whiterectdrei = color(255, 255, 255);
noFill()
stroke(whiterectdrei);
strokeWeight(1)
rect(150, 150, 300, 300);

let whiterectvier = color(255, 255, 255);
noFill()
stroke(whiterectvier);
strokeWeight(1)
rect(200, 200, 200, 200);

let whiterectfünf = color(255, 255, 255);
noFill()
stroke(whiterectfünf);
strokeWeight(1)
rect(250, 250, 100, 100);

let whiterectfünffill = color(255, 255, 255);
noStroke()
fill(whiterectfünffill);
rect(250, 250, 100, m);
